...
try { db.exec('ALTER TABLE users ADD COLUMN intro_video TEXT'); } catch (e) { /* exists */ }
...
try { db.exec('ALTER TABLE users ADD COLUMN max_kids INTEGER'); } catch (e) { /* exists */ }        // littles at once, including her own
